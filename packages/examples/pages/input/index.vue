  ...
  <view class="layout">
    ...
    <view class="flex-col" style="background-color: gray;width: 97vw;height: 30vh;">
      <ZListCard>
        ...
        <ZInput
          ...
          :label="_.label" 
		  :labelWidth='_.labelWidth'
          :type="_.type"
          :placeholder="_.placeholder"
          :required="_.required"
          :disabled="_.disabled"
          :textarea="_.textarea"
          :bottomLine="_.bottomLine"
          :rule="_.rule"
    ...
    <ZListCard>
      ...
      <u-form-item label="textarea">
        <ZSwitch :value="_.textarea" @onChange="_.textarea=!_.textarea" />
      </u-form-item>

      <!-- 必填红星 -->
      <u-form-item label="required ">
        <ZSwitch :value="_.required" @onChange="_.required=!_.required" />
      </u-form-item>

      <!-- 禁用态 -->
      <u-form-item label="disabled">
        <ZSwitch :value="_.disabled" @onChange="_.disabled=!_.disabled" />
      </u-form-item>

      <!-- 底部分割线 -->
      <u-form-item label="bottomLine">
        <ZSwitch :value="_.bottomLine" @onChange="_.bottomLine=!_.bottomLine" />
      </u-form-item>
    </ZListCard>
  </view>
</template>
