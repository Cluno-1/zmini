...
if (!Array) {
  ...
  (_easycom_ZButton2 + _easycom_ZInput2 + _easycom_ZSwitch2 + _easycom_u_form_item2 + _easycom_ZListCard2)();
}
...
if (!Math) {
  (_easycom_ZButton + _easycom_ZInput + _easycom_ZSwitch + _easycom_u_form_item + _easycom_ZListCard)();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        n: common_vendor.o(($event) => _.loading = !_.loading),
        o: common_vendor.p({
          value: _.loading
        }),
        p: common_vendor.p({
        ...
        q: common_vendor.o(($event) => _.round = !_.round),
        r: common_vendor.p({
          value: _.round
        }),
        s: common_vendor.p({
